...
function TimePickerNew({ init_time = null, endTime = null, selectAction, showExtendedTimeUi = true, required }) {
    ...
    return (
        <div className='inline-block px-5 text-gray-700 bg-white rounded-lg shadow-lg'>
            <div className='flex items-center justify-between'>
                <div className='flex flex-col items-center justify-between px-2 text-3xl rounded-lg select-none cursor-n-resize'>
            ...
            {showExtendedTimeUi ? <div className='flex items-center justify-between mx-2 mb-2 text-2xl bg-gray-200 select-none rounded-br5'>
                <AiOutlineMinus onClick={() => endTimeChange('minus')} className='p-2 m-1 text-3xl cursor-pointer bg-cListItem rounded-br5' />
                <div>{eTime}</div>
                <AiOutlinePlus onClick={() => endTimeChange('plus')} className='p-2 m-1 text-3xl cursor-pointer bg-cListItem rounded-br5' />
            </div> : ""}
