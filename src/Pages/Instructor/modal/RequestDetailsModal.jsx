...
function RequestDetailsModal() {
    ...
    const { setShowRejectionReasonModal, showRequestDetailsModal, setShowRequestDetailsModal, schoolInstructorDetails, setShowAcceptNoteModal } = useSchoolInstructorStore();
    ...
    useEffect(() => {
        window.scrollTo(0, 0);
        if (school_instructor_id && showRequestDetailsModal === true) { getSchoolInstructorDetails(school_instructor_id) }
    }, [school_instructor_id, showRequestDetailsModal])
